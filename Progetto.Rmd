...
#parte che lo levato sotto per provare a fare sta roba
```
...
```{r}
ora_ce@result[1:10, c(4,5,8)]
ora_ne@result[1:10,c(4,5,8)]
ora_ne_ce@result[1:10,c(4,5,8)]

oraGO_ce@result[1:10,c(2,3,6)]
oraGO_ne@result[1:10,c(2,3,6)]
oraGO_ne_ce@result[1:10,c(2,3,6)]
```
...
```
```{r}
gse_ne@result[1:10,c(2,3,5)]
gse_ce@result[1:10,c(2,3,5)]
gse_ne_ce@result[1:10,c(2,3,5)]

gseGO_ce@result[1:10,c(2,3,5)]
gseGO_ne@result[1:10,c(2,3,5)]
gseGO_ne_ce@result[1:10,c(2,3,5)]
```
...
DEFINIRE ASSOLUTAMENTE UNA DESTRA E SX PER TUTTI
